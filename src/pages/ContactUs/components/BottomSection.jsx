      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <a 
            ...
            className="block bg-white py-12 px-6 flex flex-col items-center justify-center shadow-[0_4px_20px_rgb(0,0,0,0.03)] rounded-sm hover:-translate-y-1 transition-transform duration-300"
          >
            <div className="w-20 h-20 bg-[#01ab4a] rounded-full flex items-center justify-center mb-6 shadow-md shadow-[#01ab4a]/30">
